...
| platform | download |
|----------|----------|
| **macOS** | [`aloud_1.0.8_aarch64.dmg`](https://github.com/akrusz/aloud/releases/download/v1.0.8/aloud_1.0.8_aarch64.dmg) — open the DMG, drag aloud to Applications |
| **Windows** | [`aloud_1.0.8_x64-setup.exe`](https://github.com/akrusz/aloud/releases/download/v1.0.8/aloud_1.0.8_x64-setup.exe) — run the installer |
| **Linux** | [`aloud_1.0.8_amd64.AppImage`](https://github.com/akrusz/aloud/releases/download/v1.0.8/aloud_1.0.8_amd64.AppImage) — `chmod +x`, double-click or run from terminal |
