...
docs/
  ...
  privacy/        ← privacy policy (hand-written; carries a PRE-PUBLISH checklist comment)
  terms/          ← terms of service (likewise)
...
- [ ] before public launch, work through the PRE-PUBLISH checklist comments in
      `privacy/index.html` and `terms/index.html` (account fields, payment
      processor, provider list, refund stance, BYO-key policy on web)
