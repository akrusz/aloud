 ...
 * are explained once, under the AI Provider select ("☁️: approximate hourly
 * credit usage", #cloud-rate-legend), freeing the slot under the model select
 * for the "Show all available models" toggle.
 *
