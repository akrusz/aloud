...
| platform | download |
|----------|----------|
| **macOS** | [`aloud_2.6.1_aarch64.dmg`](https://github.com/akrusz/aloud/releases/download/v2.6.1/aloud_2.6.1_aarch64.dmg) - open the DMG, drag aloud to Applications |
| **Windows** | [`aloud_2.6.1_x64-setup.exe`](https://github.com/akrusz/aloud/releases/download/v2.6.1/aloud_2.6.1_x64-setup.exe) - run the installer |
| **Linux** | [`aloud_2.6.1_amd64.AppImage`](https://github.com/akrusz/aloud/releases/download/v2.6.1/aloud_2.6.1_amd64.AppImage) - `chmod +x`, double-click or run from terminal |
