 ...
 * are explained once, right under the AI provider/model row ("☁️: approximate
 * hourly credit usage", #cloud-rate-legend), freeing the slot under the model
 * select for the "Show all available models" toggle.
 *
