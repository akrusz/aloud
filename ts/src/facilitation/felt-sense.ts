...
Move on with [NEXT] once one thing has been chosen, or clearly chooses itself. If a small inventory has formed and nothing is chosen yet, ask: "Which of these wants your attention today?"`,
    },
    {
        id: 'sensing',
        label: 'sensing',
...
Move on with [NEXT] once they're in contact with an actual body-sense: a place or a quality, however vague.
Go back with [BACK] if it's all too much at once and things need setting down again.`,
    },
    {
        id: 'handle',
        label: 'finding words',
...
Move on with [NEXT] as soon as a candidate has arrived; checking it is the next stage's work.
Go back with [BACK] if contact with the body-sense has been lost and it needs to re-form.`,
    },
    {
        id: 'resonating',
        label: 'checking',
...
Move on with [NEXT] when a handle clearly resonates: a felt shift, a release, a clear "yes".
Go back with [BACK] if the felt sense itself has gone quiet or changed and needs sensing freshly.`,
    },
    {
        id: 'asking',
        label: 'asking',
...
Move on with [NEXT] when something has come with a felt shift, or when the asking has gently run its course for today.
Go back with [BACK] if contact with the felt sense is lost.`,
    },
    {
        id: 'receiving',
        label: 'receiving',
...
This is the last stage, so there is no [NEXT]. If something new and alive opens and they clearly want to go on, you may go back with [BACK] to asking.`,
    },
];
